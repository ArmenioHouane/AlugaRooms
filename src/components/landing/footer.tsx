      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Faça reservas de quartos completo e fácil de usar.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-sm text-muted-foreground">
                <strong>Email:</strong> contato@alugarooms.co.mz
              </li>
              <li className="text-sm text-muted-foreground">
                <strong>Telefone:</strong> +258 865010307
              </li>
              <li className="text-sm text-muted-foreground">
                <strong>Endereço:</strong> Av. Malhangalene, Maputo
              </li>
            </ul>
          </div>
        </div>
        <div className="border-t border-border mt-8 pt-8 text-center">
          <p className="text-sm text-muted-foreground">
            &copy; {new Date().getFullYear()} AlugaRooms Feito por DevSolutions. Todos os direitos reservados.
          </p>
        </div>
      </div>
    </footer>
